            ...
            <div className="flex min-h-screen flex-col items-center bg-background p-6 text-foreground lg:justify-center lg:p-8">
                        ...
                        {auth.user ? (
                            <>
                                <Link
                                    ...
                                    className="inline-block rounded-sm border border-border px-5 py-1.5 text-sm leading-normal text-foreground hover:border-border/70 hover:bg-secondary"
                                >
                                    Dashboard
                                </Link>
                                <Link
                                    href="/color-demo"
                                    className="inline-block rounded-sm border border-primary px-5 py-1.5 text-sm leading-normal text-primary hover:bg-primary hover:text-primary-foreground dark:border-primary dark:text-primary dark:hover:bg-primary dark:hover:text-primary-foreground"
                                >
                                    Color Demo
                                </Link>
                            </>
                            ...
                            <>
                                <Link
                                    href={route('login')}
                                    className="inline-block rounded-sm border border-transparent px-5 py-1.5 text-sm leading-normal text-foreground hover:border-border hover:bg-secondary"
                                >
                                    Log in
                                </Link>
                                <Link
                ...
                <div className="flex w-full items-center justify-center opacity-100 transition-opacity duration-750 lg:grow starting:opacity-0">
                    <main className="flex w-full max-w-[335px] flex-col-reverse lg:max-w-4xl lg:flex-row">
                        <div className="flex-1 rounded-br-lg rounded-bl-lg border border-border bg-card p-6 pb-12 text-[13px] leading-[20px] text-card-foreground lg:rounded-tl-lg lg:rounded-br-none lg:p-20">
